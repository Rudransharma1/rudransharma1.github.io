...
const appCss = "/assets/styles-CmdyIxWb.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Rudransh Sharma — Data & BI Analyst | AI-Driven Analytics" },
      { name: "description", content: "Engineering intelligence through data. Portfolio of Rudransh Sharma — Data & BI Analyst building dashboards, predictive models, and AI-driven analytics systems." },
      { name: "author", content: "Rudransh Sharma" },
      { property: "og:title", content: "Rudransh Sharma — Engineering Intelligence Through Data" },
      { property: "og:description", content: "Data Analytics • Business Intelligence • AI Systems • Predictive Insights" },
...
const $$splitComponentImporter = () => import("./index-B1jPRgWd.js");
